...
public class SellerService {
    ...
    public List<SellerDto> getAllSeller(){
        Iterable<Seller> sellersList= sellerRepository.findAll();
        List<SellerDto> sellerDtoList = new ArrayList<>();
        sellersList.forEach(sellers -> sellerDtoList.add(new SellerDto(sellers.getId(),sellers.getEmail(),
                sellers.getFirstName(),
                sellers.getMiddleName(),sellers.getLastName(),sellers.getCompanyContact(),sellers.getCompanyName(),sellers.getGst())));
