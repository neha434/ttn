...
public List<OrderDto> getAllOrder(){
    ...
    public OrderDto getOrder(int id) {
        ...
        orderDto.getCustomerAddressAddressLine(order.setCustomerAddressAddressLine());
        orderDto.getCustomerAddressCity(order.setCustomerAddressCity());
        orderDto.getCustomerAddressState(order.setCustomerAddressState());
        orderDto.getCustomerAddressCity(order.setCustomerAddressCity());
        orderDto.getCustomerAddressCountry(order.setCustomerAddressCountry());
        orderDto.getCustomerAddressLabel(order.setCustomerAddressLabel());
        orderDto.getCustomerAddressZipCode(order.setCustomerAddressZipCode());
        return orderDto;
    }
